public ShowLSPDRecruitmentDialog(playerid)
{
    ...
    strcat(dialogText, "you must first obtain an {FFFF00}LSPD Permit{FFFFFF}.\n\n", sizeof(dialogText));
    ...
    strcat(dialogText, "{A9A9A9}Tickets > Buy{FFFFFF}\n\n", sizeof(dialogText));

    strcat(dialogText, "A senior staff member will assist you and\n", sizeof(dialogText));
    strcat(dialogText, "guide you through the application process.\n", sizeof(dialogText));
    strcat(dialogText, "A small contribution is required to obtain the permit.\n\n", sizeof(dialogText));
